...
function Transaction() {
  ...
  const deleteExpense = async (id2) => {
    try {
      const res = await axios_default.delete(`http://localhost4000/api/expense/delete/${id2}`);
  ...
  const updateExpense = async (id2) => {
    var _a2;
    try {
      const config = { headers: { "Content-Type": "application/json" } };
      const res = await axios_default.put(`http://localhost4000/api/expense/update/${id2}`, {
...
//# sourceMappingURL=/build/routes/user/transaction/$transaction-J7LOPOZ2.js.map
