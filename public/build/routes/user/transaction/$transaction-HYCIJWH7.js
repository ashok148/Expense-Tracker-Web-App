...
function Transaction() {
  ...
  const deleteExpense = async (id) => {
    try {
      const res = await axios_default.delete(`http://localhost4000/api/expense/delete/${id}`);
      const mydata = await (res == null ? void 0 : res.data);
      return { mydata };
    } catch (error) {
      return { error };
    }
  ...
  const updateExpense = async (id) => {
    ...
    try {
      ...
      const res = await axios_default.put(`http://localhost4000/api/expense/update/${id}`, {
      ...
      const mydata = await ((_a2 = res == null ? void 0 : res.data) == null ? void 0 : _a2.expense);
      return { mydata };
    } catch (error) {
      return { error };
    }
  ...
  const showModalEdit = (id) => {
    js_cookie_default.set("expense_id", id);
  ...
  const handleOk = () => {
    const id = js_cookie_default.get("expense_id");
    updateExpense(id);
...
//# sourceMappingURL=/build/routes/user/transaction/$transaction-HYCIJWH7.js.map
